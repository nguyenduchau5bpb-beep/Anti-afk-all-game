...
if CoreGui:FindFirstChild("MrGhostHub_UltraVIP_Engine") then
    CoreGui["MrGhostHub_UltraVIP_Engine"]:Destroy()
end
...
-- ================================================
-- 5. ENGINE CHONG AFK & CHONG DISCONNECT
-- ================================================
...
local function loadMainHub()
    ...
    -- ================================================
    -- 7. NUT PHU CYBER GHOST (ZINDEX 10000)
    -- ================================================
